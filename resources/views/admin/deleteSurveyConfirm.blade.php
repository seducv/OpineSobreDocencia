...
<div class="container register">
    <div class="row">
        <div class="col-xs-10 col-sm-6 col-md-6 col-xs-offset-1 col-sm-offset-3 size-p">
            <h3 class="text-center">¿Desea eliminar  la  encuesta seleccionada definitivamente ?  </h3>
            ...
            @endif
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/dashboard/confirmar-eliminacion-encuesta') }}">
                {{ csrf_field() }}
                
                {{ Form::hidden('id', $survey_id) }}
